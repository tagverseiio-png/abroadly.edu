                ...
                <div className="space-y-3.5">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <input name="fullName" type="text" className="w-full sm:w-1/2 bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm font-medium transition-all" placeholder="Full Name" />
                      <div className="flex w-full sm:w-1/2 gap-1 bg-slate-50 border border-slate-200 rounded-lg pr-3 focus-within:ring-2 focus-within:ring-emerald-500 transition-all overflow-hidden">
