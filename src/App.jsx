...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-slate-900 selection:bg-emerald-200 selection:text-emerald-900 relative">
      ...
      <a href="https://wa.me/60123456789" target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#128C7E] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 group flex items-center justify-center animate-bounce" style={{ animationDuration: '3s' }}>
                ...
                <div className="space-y-3.5">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <input name="fullName" type="text" className="w-full sm:w-1/3 bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm font-medium transition-all" placeholder="Full Name" />
                      <input name="email" type="email" className="w-full sm:w-1/3 bg-slate-50 border border-slate-200 rounded-lg px-3 py-2.5 text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm font-medium transition-all" placeholder="Email" />
                      <div className="flex w-full sm:w-1/3 gap-1 bg-slate-50 border border-slate-200 rounded-lg pr-3 focus-within:ring-2 focus-within:ring-emerald-500 transition-all overflow-hidden">
                        ...
                        <input name="phone" type="tel" className="w-full bg-transparent px-2 py-2.5 text-slate-900 focus:outline-none text-sm font-medium" placeholder="WhatsApp No." />
                      </div>
                    </div>
                  </div>
                </div>
